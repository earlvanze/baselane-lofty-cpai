...
export SEND_MONTHLY_DISCORD_REVIEW_DRAFTS="${SEND_MONTHLY_DISCORD_REVIEW_DRAFTS:-1}"
export SEND_MONTHLY_DISCORD_PROPERTY_UPDATE="${SEND_MONTHLY_DISCORD_PROPERTY_UPDATE:-0}"
export SEND_OWNER_EMAILS="${SEND_OWNER_EMAILS:-0}"
export SEND_NATIVE_LOFTY_OWNER_EMAILS="${SEND_NATIVE_LOFTY_OWNER_EMAILS:-0}"
export SEND_TRANSFER_RECONCILIATION_TELEGRAM="${SEND_TRANSFER_RECONCILIATION_TELEGRAM:-0}"
