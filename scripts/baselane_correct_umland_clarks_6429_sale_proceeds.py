#!/usr/bin/env python3
"""Correct the Umland-to-Clarks transfer to a sale-proceeds pass-through."""
...
REPORT = ROOT / "reports" / "baselane_umland_clarks_6429_sale_proceeds.20260729.json"
APPLY_ENV = "BASELANE_UMLAND_CLARKS_SALE_PROCEEDS_APPLY"
APPLY_DIGEST_ENV = "BASELANE_UMLAND_CLARKS_SALE_PROCEEDS_DIGEST"
TRANSACTION_ID = "174466095"
PROPERTY_ID = "83184"
BANK_ACCOUNT_ID = "119345"
TRANSFER_TAG_ID = "24"
INTERIM_RECEIVABLE_TAG_ID = "34"
NOTE = (
    "Pass-through settlement of Kraig Clark Lofty sale proceeds received via "
    "Coinbase: $9,800.00 received, less $3,370.93 of Umland Airbnb rent "
    "previously deposited to Clarks Corner Investments' Chase account; "
    "$6,429.07 remainder returned to Clarks Corner. Not an owner distribution, "
    "expense, reimbursement, or receivable. Corrected 2026-07-29; existing cash "
    "movement preserved."
)
...
def query_candidates() -> list[dict[str, Any]]:
    ...
    for search in (
        "Receivable from Clarks Corner",
        "Pass-through settlement of Kraig Clark Lofty sale proceeds",
    ):
...
def read_live_target() -> dict[str, Any]:
    ...
    if (
        ...
        or actual["tag_id"] not in (INTERIM_RECEIVABLE_TAG_ID, TRANSFER_TAG_ID)
    ...
    return {
        **actual,
        "target_tag_id": TRANSFER_TAG_ID,
        "target_note": NOTE,
        "already_applied": actual["tag_id"] == TRANSFER_TAG_ID and actual["note"] == NOTE,
    }
...
def main() -> int:
    ...
    report = {
        ...
        "accounting_treatment": (
            "$6,429.07 pass-through settlement of Kraig Clark Lofty sale proceeds: "
            "$9,800.00 received via Coinbase less $3,370.93 Umland Airbnb rent."
        ),
        "reverses_interim_receivable_classification": True,
        "supported_clarks_reimbursements_unchanged": {
